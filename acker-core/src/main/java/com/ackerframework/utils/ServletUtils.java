...
public class ServletUtils {
    ...
    // 静态文件后缀
    private final static String[] staticFiles = StringUtils.split(GlobalUtils.getConfig(Constant.WEN_STATICFILE), ",");

    // 动态映射URL后缀
    private final static String urlSuffix = GlobalUtils.getUrlSuffix();
