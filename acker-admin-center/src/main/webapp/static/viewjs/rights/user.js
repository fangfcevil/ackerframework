$.fView.url = {
    formlist: $.fView.contextPath + "/admin/center/rights/user/formlist",
    gridlist: $.fView.contextPath + "/admin/center/rights/user/gridlist",
    formitem: $.fView.contextPath + "/admin/center/rights/user/formitem",
    insert: $.fView.contextPath + "/admin/center/rights/user/insert",
    update: $.fView.contextPath + "/admin/center/rights/user/update",
    delete: $.fView.contextPath + "/admin/center/rights/user/delete"
};
