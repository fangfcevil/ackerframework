$.fView.url = {
    formlist: $.fView.contextPath + "/admin/center/rights/org/formlist",
    gridlist: $.fView.contextPath + "/admin/center/rights/org/gridlist",
    formitem: $.fView.contextPath + "/admin/center/rights/org/formitem",
    insert: $.fView.contextPath + "/admin/center/rights/org/insert",
    update: $.fView.contextPath + "/admin/center/rights/org/update",
    delete: $.fView.contextPath + "/admin/center/rights/org/delete"
};
